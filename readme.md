...
## 📝 Descriere
**UPSC SIMU Plus** este o extensie Chrome avansată concepută pentru a ușura munca profesorilor de la Universitatea Pedagogică de Stat „Ion Creangă”. Aceasta transformă registrul electronic SIMU dintr-o unealtă statică într-un asistent digital inteligent.
...
### 2. 📋 Gestionare teme curriculum (Optimizat) - NOU (v13.6)
...
### 3. 🌙 Mod Întunecat (Dark Mode)
*   Interfață complet adaptată pentru protecția ochilor pe timp de noapte.
*   Activabil rapid din panoul de setări (roata dințată).
